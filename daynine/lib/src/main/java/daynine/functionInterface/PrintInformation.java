package daynine.functionInterface;
@FunctionalInterface
public interface PrintInformation {
	 // If one single abstract method is present in an Interface then
    //this interface
    // will be known as functional interface
    public void printMessage(String message);
    /**
     * In a functional interface only one abstract method will be present
     * You can use default and static methods
     */
